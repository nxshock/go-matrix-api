...
- [x]                5.3.4.2   Google ReCaptcha
- [x]                5.3.4.3   Token-based
- [x]                5.3.4.4   OAuth2-based
- [x]                5.3.4.5   Email-based (identity server)
- [x]                5.3.4.6   Dummy Auth
- [x]            5.3.5   Fallback
- [x]                5.3.5.1   Example
...
- [ ]            9.4.3   Leaving rooms
- [v]                9.4.3.1   POST /_matrix/client/r0/rooms/{roomId}/leave
